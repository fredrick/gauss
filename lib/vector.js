...
var Vector = function(values) {
    ...
    vector.pow = function(exponent, callback) {
        var pow = new Vector(vector.map(function(x) {
    ...
    vector.asc = function(a, b) {
        return a - b;
    };

    vector.desc = function(a, b) {
        return b - a;
    };
    ...
    vector.copy = function(callback) {
        var copy = new Vector(vector.slice(0));
        if (callback)
