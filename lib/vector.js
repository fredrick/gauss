    ...
    Object.defineProperties(vector, {
      'indexOf': {
        value: function(element, callback) {
          return Collection.indexOf.apply(this, arguments);
        },
        writable: true,
        enumerable: false
      },
      ...
      'mode': {
        value: function(callback) {
          return Collection.mode.apply(this, arguments);
        },
        writable: true,
        enumerable: false
      },
      ...
      'frequency': {
        value: function(element, callback) {
          return Collection.frequency.apply(this, arguments);
        },
        writable: true,
        enumerable: false
      },
      ...
      'distribution': {
        value: function(format, callback) {
          return Collection.distribution.apply(this, arguments);
        },
        writable: true,
        enumerable: false
      },
      ...
      'sample': {
        value: {
          mean: function(callback) {
            var mean = this.sum() / (this.length - 1);
            if (callback)
              return callback(mean);
            else
              return mean;
          ...
          gmean: function(callback) {
            var gmean = Math.pow(Math.abs(this.product()), 1 / (this.length - 1));
            if (callback)
              return callback(gmean);
            else
              return gmean;
          ...
          hmean: function(callback) {
            ...
            var hmean = (this.length - 1) / reciprocalSum(this);
            if (callback)
              return callback(hmean);
            else
              return hmean;
          ...
          qmean: function(callback) {
              var qmean = Math.sqrt(this.pow(2).sum() / (this.length - 1))
              if (callback)
                return callback(qmean);
              else
                return qmean;
      ...
      'equal': {
        value: function(that, callback) {
          return Collection.equal.apply(this, arguments);
        },
        writable: true,
        enumerable: false
      },
      ...
      'clone': {
        value: function(callback) {
          return Collection.clone.apply(this, arguments);
        },
        writable: true,
        enumerable: false
      },
      ...
      'toArray': {
        value: function(callback) {
          return Collection.toArray.apply(this, arguments);
        },
        writable: true,
        enumerable: false
      },
      ...
      'some': {
        value: function(callback, next) {
          return Collection.some.apply(this, arguments);
        },
        writable: true,
        enumerable: false
      },
      'reduce': {
        value: function(callback, initialValue, next) {
          return Collection.reduce.apply(this, arguments);
        },
        writable: true,
        enumerable: false
      },
      'reduceRight': {
        value: function(callback, initialValue, next) {
          return Collection.reduceRight.apply(this, arguments);
        },
        writable: true,
        enumerable: false
      },
