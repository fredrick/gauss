...
(function() {
  ...
  var Vector = function(values) {
    ...
    Object.defineProperties(vector, {
       ...
       */
      'add': {
        value: function(o, callback) {
          var res = [];
          if(Array.isArray(o)) {
            if(o.length !== this.length) {
              throw new RangeError("Can't add vectors of differing lengths")
            }
            for (var i = 0; i < this.length; i++) {
              res[i] = this[i] + o[i];
            }
          ...
          if (callback)
            return callback(new Vector(res));
          else
      ...
      'subtract': {
        value: function(o, callback) {
          ...
          if(Array.isArray(o)) {
            if(o.length !== this.length) {
              throw new RangeError("Can't subtract vectors of differing lengths")
            }
            for (var i = 0; i < this.length; i++) {
              res[i] = this[i] - o[i];
            }
      ...
      'multiply': {
        value: function(o, callback) {
          ...
          if(Array.isArray(o)) {
            if(o.length !== this.length) {
              throw new RangeError("Can't multiply vectors of differing lengths")
            }
            for (var i = 0; i < this.length; i++) {
              res[i] = this[i] * o[i];
            }
      ...
      'divide': {
        value: function(o, callback) {
          ...
          if(Array.isArray(o)) {
            if(o.length !== this.length) {
              throw new RangeError("Can't divide vectors of differing lengths")
            }
            for (var i = 0; i < this.length; i++) {
              res[i] = this[i] / o[i];
            }
